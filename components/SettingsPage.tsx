...
export const SettingsPage: React.FC = () => {
  ...
  const handleSync = async () => {
    ...
    await syncCustomersMock(); // Call mock service
              ...
              <div className="p-6">
                <div className="flex flex-col sm:flex-row items-start justify-between gap-6">
                  <div className="flex gap-5">
                    <div className="w-14 h-14 bg-[#c0392b] rounded-xl flex items-center justify-center text-white font-bold text-2xl shadow-lg shadow-red-900/20">
                      F
                    </div>
                    <div>
                      ...
                      <div className="flex items-center gap-4 mt-4 text-xs font-medium text-slate-500">
                        ...
                        <span>{t('settings.last_synced')}: <span className="text-slate-700">{lastSynced || "2 hours ago"}</span></span>
                      </div>
                    </div>
                  </div>
                  <button 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           ...
           <section className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden h-fit">
              ...
              <div className="p-6">
                ...
                <button className="w-full py-3 border border-gray-200 rounded-xl text-sm font-bold text-slate-700 hover:bg-slate-50 hover:text-slate-900 transition-colors shadow-sm">
             ...
             <table className="w-full text-left text-sm text-slate-600">
                ...
                <tbody className="divide-y divide-gray-50">
                   <tr className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="px-8 py-5 text-right font-medium text-slate-500">2 mins ago</td>
                   </tr>
                   <tr className="hover:bg-gray-50/50 transition-colors">
                      <td className="px-8 py-5">
                          <div className="flex items-center gap-3">
                      ...
                      <td className="px-6 py-5"><span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-emerald-50 text-emerald-700 rounded-full text-xs font-bold border border-emerald-100"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500"></div>{t('settings.active_status')}</span></td>
                      <td className="px-8 py-5 text-right font-medium text-slate-500">1 hour ago</td>
                   </tr>
                   <tr className="hover:bg-gray-50/50 transition-colors">
                      <td className="px-8 py-5">
                          <div className="flex items-center gap-3">
                      ...
                      <td className="px-8 py-5 text-right font-medium text-slate-500">2 days ago</td>
                   </tr>
                </tbody>
             </table>
           </div>
