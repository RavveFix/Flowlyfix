  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const systemPrompt = `
        ...
        4. Customers: Manage customer registry and sync with Fortnox.
        5. Resources: Manage Assets (Machines) and Technicians.
        6. Settings: Configure language, integrations (Fortnox), and organization details.
        7. Field App: A mobile view for technicians to see their assigned jobs ("My Day"), travel, start jobs, and sign off.

        Key Features:
        - Fortnox Integration: Syncs customers and creates draft invoices.
          ...
          <div className="bg-[#0a192f] p-4 flex justify-between items-center text-white">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-blue-200">System Expert</p>
              </div>
            </div>
